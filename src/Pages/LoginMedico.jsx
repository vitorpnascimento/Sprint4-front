...
function LoginMedico() {
    function validateLogin() {
        ...
        if (numeroSus === "1234") {
            window.location.href = "/feedback_medico";
        } else {
    ...
    return (
        <div style={{ fontFamily: 'Arial, sans-serif', backgroundColor: '#f4f4f4', margin: 0, padding: 0, boxSizing: 'border-box', display: 'flex', alignItems: 'center', justifyContent: 'center', height: '100vh' }}>
            <form id="loginForm" style={{ backgroundColor: '#fff', padding: '20px', borderRadius: '8px', boxShadow: '0 0 10px rgba(0, 0, 0, 0.1)' }}>
                <label htmlFor="numeroSus" style={{ display: 'block', marginBottom: '10px' }}>Número do CRM:</label>
                <input type="text" id="numeroSus" name="numeroSus" placeholder="Digite seu número do CRM" style={{ width: '100%', padding: '8px', marginBottom: '15px', border: '1px solid #ccc', borderRadius: '4px', boxSizing: 'border-box' }} />
